...
for required in dist/entrypoints/production-server.js dist/entrypoints/production-calendar-sync.js dist/entrypoints/production-plan-state-migration.js dist/entrypoints/production-plan-refresh.js dist/entrypoints/production-classroom-refresh.js dist/entrypoints/m17-powerschool-repair.js dist/entrypoints/job.js .chalkwright-release.json systemd/production/chalkwright.service.in systemd/production/chalkwright-powerschool-repair.service.in; do
