...
cleanup() {
  ...
  for name in chalkwright-canary.service chalkwright-canary-plan-preflight.service chalkwright-canary-plan-refresh.service chalkwright-canary-plan-refresh.timer chalkwright-canary-classroom-preflight.service chalkwright-canary-classroom-refresh.service chalkwright-canary-classroom-refresh.timer chalkwright-canary-calendar-preflight.service chalkwright-canary-calendar-sync.service chalkwright-canary-calendar-sync.timer chalkwright-canary-comparison.service chalkwright-canary-comparison-observation.service chalkwright-canary-integrity.service chalkwright-canary-integrity.timer chalkwright-canary-backup.service chalkwright-canary-backup.timer; do
...
for required in dist/entrypoints/m17-canary-server.js dist/entrypoints/production-plan-refresh.js dist/entrypoints/production-classroom-refresh.js dist/entrypoints/m17-canary-calendar-sync.js dist/entrypoints/m17-canary-activation-manifest.js dist/entrypoints/m17-canary-comparison.js scripts/operations/activate-m17-canary.sh scripts/operations/stop-m17-canary.sh scripts/operations/bind-m17-activation-manifest.mjs systemd/m17/chalkwright-canary.service.in systemd/m17/chalkwright-canary-plan-preflight.service.in systemd/m17/chalkwright-canary-classroom-preflight.service.in; do
...
committed=1
echo "{\"status\":\"installed-inert\",\"release\":\"sha256:$digest\",\"unitsInstalled\":16,\"unitsStarted\":0,\"providerRequests\":0,\"routeChanges\":0}"
